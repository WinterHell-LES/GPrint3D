...
-- Usuario - Cliente 1
insert into usuarios (usu_email, usu_senha, usu_regra, usu_ativo)
values ('cliente1@gprint3d.com', '$2a$10$TMfY1IunLWQy/wfKgltNZ.jyaJObeOdAfBK2VPicJzVh10P0nnDQO', 'ROLE_CLIENTE', true);

-- Cliente
insert into clientes (cli_tipo, cli_nome, cli_sobrenome, cli_sexo, cli_dtnasc, cli_usu_id)
values ('Bronze', 'Sérgio Levi', 'Yuri Melo', 'Masculino', '1945-09-23', '2');

-- Documento
insert into documentos (doc_nome, doc_numero, doc_validade, doc_cli_id)
values ('CPF', '91294168509', null, '1');
...
-- Usuario - Cliente 2
insert into usuarios (usu_email, usu_senha, usu_regra, usu_ativo)
values ('cliente2@gprint3d.com', '$2a$10$TMfY1IunLWQy/wfKgltNZ.jyaJObeOdAfBK2VPicJzVh10P0nnDQO', 'ROLE_CLIENTE', true);
...
-- Usuario - Cliente 3
insert into usuarios (usu_email, usu_senha, usu_regra, usu_ativo)
values ('cliente3@gprint3d.com', '$2a$10$TMfY1IunLWQy/wfKgltNZ.jyaJObeOdAfBK2VPicJzVh10P0nnDQO', 'ROLE_CLIENTE', true);
...
-- Usuario - Cliente 4
insert into usuarios (usu_email, usu_senha, usu_regra, usu_ativo)
values ('cliente4@gprint3d.com', '$2a$10$TMfY1IunLWQy/wfKgltNZ.jyaJObeOdAfBK2VPicJzVh10P0nnDQO', 'ROLE_CLIENTE', true);
...
-- Usuario - Cliente 5
insert into usuarios (usu_email, usu_senha, usu_regra, usu_ativo)
values ('cliente5@gprint3d.com', '$2a$10$TMfY1IunLWQy/wfKgltNZ.jyaJObeOdAfBK2VPicJzVh10P0nnDQO', 'ROLE_CLIENTE', true);

-- Cliente
insert into clientes (cli_tipo, cli_nome, cli_sobrenome, cli_sexo, cli_dtnasc, cli_usu_id)
values ('Bronze', 'Calebe Mateus', 'Daniel Barbosa', 'Masculino', '1955-03-10', '6');

-- Documento
insert into documentos (doc_nome, doc_numero, doc_validade, doc_cli_id)
values ('CPF', '47196638344', null, '5');
