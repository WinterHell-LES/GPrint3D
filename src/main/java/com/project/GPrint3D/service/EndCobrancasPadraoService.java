...
@Service
public class EndCobrancasPadraoService 
{
    @Autowired
    private EndCobrancasPadroesRepository endCobrancasPadroes;

    public String[] cadastrar(EndCobrancasPadroesModel endCobrancasPadrao)
    {
        ...
        try 
        {
            endCobrancasPadroes.save(endCobrancasPadrao);
    ...
    public String[] atualizar(EndCobrancasPadroesModel endCobrancasPadrao)
    {
        String[] response = new String[2];
