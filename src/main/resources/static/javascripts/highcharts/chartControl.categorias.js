Highcharts.getJSON('http://localhost:8080/admin/graphFeed/categorias', function (data)
{
    var data2 = data;
    var define2 = [];
    ...
    data2.forEach(element =>
    {
        ...
        data2.forEach(e =>
        {
            ...
            {
                if (define[0].categoria_nome == e.categoria_nome)
                {
                    define.push(conteudo);
                }
            }
        ...
        data2 = data2.filter(e => { return categoria != e.categoria_nome });
    });
    ...
    Highcharts.stockChart('container',
    {
        ...
        exporting: {
            filename: "Demonstrativo de vendas por categoria",
            scale: 3
        },
